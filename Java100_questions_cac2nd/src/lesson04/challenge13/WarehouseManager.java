...
public class WarehouseManager {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < greetingArray.length; i++) {
			System.out.println("あいさつパターン" + (i + 1) + "..." + "「" + greetingArray[i] + "」");
		}
		...
		String fix_numString = br.readLine();
		int fix_num = Integer.parseInt(fix_numString);

		System.out.println("あいさつを吹き込んでください＞");
		greetingArray[fix_num - 1] = br.readLine();
